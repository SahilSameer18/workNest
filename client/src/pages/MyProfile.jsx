...
import { Mail, Phone, Calendar, IndianRupee, ShieldAlert, Building2 } from 'lucide-react';
import toast from 'react-hot-toast';

import { getMyProfile } from '../api/employeeApi.js';
...
const MyProfile = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-4">
      {/* Header */}
      <div className="mb-4">
        <h1 className="text-ink text-2xl font-bold">My Profile</h1>
        <p className="text-gray-500 text-sm mt-1">Your personal information and employment details.</p>
      </div>
      ...
      <div className="card flex flex-col md:flex-row items-start md:items-center gap-6">
        ...
        <div className="flex-1">
          <h2 className="text-ink text-2xl font-bold leading-tight">{employee.name}</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-ink text-sm font-medium">
                    {/* Only show salary if they are not an EMPLOYEE, or if policy allows viewing own salary */}
        ...
        <div className="space-y-4">
          <div className="card h-full">
            ...
            <div className="mb-6">
              <p className="text-gray-600 text-xs mb-2">My Manager</p>
              {employee.manager ? (
                <div className="flex items-center gap-3 p-2 -ml-2 rounded-lg bg-surface-2 border border-edge">
            ...
            <div>
              <p className="text-gray-600 text-xs mb-2">My Direct Reports ({employee.reportees?.length || 0})</p>
              {employee.reportees?.length > 0 ? (
                <div className="space-y-1">
                  {employee.reportees.map((rep) => (
                    <div key={rep.id} className="flex items-center gap-2 p-1.5 -ml-1.5">
